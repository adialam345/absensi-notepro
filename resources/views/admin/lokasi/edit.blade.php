...
<head>
    ...
    <title>Edit Lokasi Kantor - Admin</title>
    ...
    <div class="bg-[#ff040c] p-3 text-white">
        <div class="flex justify-between items-center">
            <div class="flex items-center space-x-2">
                ...
                <span class="font-semibold text-sm">Edit Lokasi Kantor</span>
            </div>
        </div>
    </div>
    ...
    <div class="p-4">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                <h2 class="text-lg font-semibold text-gray-800 mb-6">Edit Data Lokasi Kantor</h2>
                ...
                <form action="{{ route('admin.lokasi.update', $lokasi->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="alamat" rows="3" required 
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#ff040c]"
                            placeholder="Masukkan alamat lengkap lokasi kantor">{{ old('alamat', $lokasi->alamat) }}</textarea>
                    </div>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Latitude</label>
                            <input type="number" name="latitude" value="{{ old('latitude', $lokasi->latitude) }}" step="any" required 
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#ff040c]"
                        ...
                        <div>
                            ...
                            <input type="number" name="longitude" value="{{ old('longitude', $lokasi->longitude) }}" step="any" required 
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#ff040c]"
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" name="radius" value="{{ old('radius', $lokasi->radius) }}" min="50" required 
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#ff040c]"
