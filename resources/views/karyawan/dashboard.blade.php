...
<body class="bg-gray-50 min-h-screen">
    ...
    <div class="bg-white rounded-t-2xl -mt-1 p-4 shadow-sm">
        <div class="flex justify-between items-start">
            <div>
                <p class="text-gray-500 text-xs">Selamat Pagi</p>
    ...
    <div class="px-4 py-3">
        <div class="grid grid-cols-6 gap-3">
            ...
            <div class="text-center">
                ...
                <span class="text-xs text-gray-700">Cuti</span>
            </div>
            <div class="text-center">
                <div class="w-10 h-10 bg-[#ff040c] rounded-xl flex items-center justify-center mx-auto mb-2">
    ...
    <div class="px-4 py-3">
        <div class="flex justify-between items-center mb-3">
            <h2 class="text-sm font-semibold text-gray-800">
                Absensi Bulan <span class="text-[#ff040c]">Juli</span>
            </h2>
            <div class="flex items-center space-x-2">
                <span class="text-gray-800 text-sm">2025</span>
            ...
            <div class="bg-white rounded-xl p-3 shadow-sm">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-600">21 Hari</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl p-3 shadow-sm">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-600">0 Hari</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl p-3 shadow-sm">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-600">2 Hari</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl p-3 shadow-sm">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-600">9 hari</p>
                    </div>
                </div>
            </div>
        </div>
