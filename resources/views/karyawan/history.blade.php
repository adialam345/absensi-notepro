...
<body class="bg-gray-50 min-h-screen">
    <!-- Header -->
    <x-karyawan-navbar title="History Absensi" subtitle="Riwayat Kehadiran" />
                    ...
                    <tbody class="divide-y divide-gray-200">
                        @forelse($absensi as $a)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-3 py-2">
                                    <span class="text-xs font-medium {{ $a->status === 'terlambat' ? 'text-red-600' : ($a->status === 'hadir' ? 'text-green-600' : 'text-gray-400') }}">
